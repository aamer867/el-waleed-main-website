        ...
        <nav className="shadow-lg relative z-20">
            <div className="container mx-auto grid grid-cols-3 lg:grid-cols-4 items-center px-4">
                ...
                <div className="lg:col-span-2 md:col-span-1 md:flex hidden items-center justify-center lg:space-x-16 space-x-4">
                    <Link href="/" className={`transition duration-300 ease-in-out hover:text-main-red-color ${pageLabel === "Home" ? styles.active : ""}`}>
                        Home
                    </Link>
                    <Link href="/about" className={`transition duration-300 ease-in-out hover:text-main-red-color ${pageLabel === "About" ? styles.active : ""}`}>
                        About
                    </Link>
