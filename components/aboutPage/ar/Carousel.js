...
const Carousel = () => {
    ...
    useEffect(() => {
        ...
        return () => clearInterval(interval); // تنظيف المؤقت عند فك تحميل المكون
    }, []);
    ...
    return (
        <div className="relative w-full overflow-hidden">
            <div className="relative h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] xl:h-[700px]"> {/* ارتفاع استجابة */}
                <Image
                    ...
                    objectFit="cover"
                    objectPosition="top"
                    priority={true} // يضمن تحميل الصور بسرعة
                />
                {/* صندوق النص */}
                <div className="absolute inset-0 flex items-center justify-center p-4">
                    <div className="bg-black bg-opacity-60 text-white p-6 sm:p-8 md:p-10 lg:p-12 xl:p-16 rounded-lg text-center max-w-lg md:max-w-xl lg:max-w-2xl mx-auto">
                        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-2 sm:mb-4">عن الوليد</h2>
                        <p className="text-sm sm:text-base md:text-lg lg:text-xl">
                            فريق محترف من المستشارين الماليين، المحاسبين المعتمدين، وخبراء الضرائب
                            يضمن أن يصل عملك إلى أعلى مستويات النجاح.
                        </p>
                    </div>
                </div>
                {/* أزرار التنقل */}
